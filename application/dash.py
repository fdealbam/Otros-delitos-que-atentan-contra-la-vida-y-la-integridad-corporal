...
TOTVSINTCORPORAL = tabla1_f.iloc[0]['GRAND TOTAL']
TASAVSINTCORPORAL = tabla1_f.iloc[0]['tasa_acumulada']
...
delitos = pd.read_csv("https://raw.githubusercontent.com/fdealbam/Otros-delitos-que-atentan-contra-la-vida-y-la-integridad-corporal/main/ODcontralavidaysegcorporal2015_2021.csv")
...
# Cintillo 000
   ...
   dbc.Row([
    ...
    html.Br(),
        ...
        dbc.Row(
           [
               dbc.Col(html.P("Otros delitos que atentan contra la vida y la integridad corporal"),
    ...
    dbc.Row(
       ...
       dbc.Row(
            [
                ...
                html.P(
                    "En otros delitos que atentan contra la vida y la integridad corporal es "
                   ...
                   " Entre 2015 y 2021 se registraron "+ str(f"{int(TOTVSINTCORPORAL):,}") +" casos, lo que representa una tasa de "+
       str(TASAVSINTCORPORAL) +" delitos por cada 100 mil habitantes. "+
    ...
    html.Br(),
     ...
     html.Br(),
       html.Br(),
        dbc.Row(
           [
               dbc.Col(html.P("Evolución de la incidencia de otros delitos que atentan contra la vida y la integridad corporal" ),
